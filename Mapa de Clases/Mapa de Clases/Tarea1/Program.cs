...
public class MiembroDeLaComunidad
{
    ...
    public MiembroDeLaComunidad(string nombre, string apellido, string email, string telefono, int edad)
    {
        Nombre = nombre;
        Apellido = apellido;
        Email = email;
...
{
    static List<MiembroDeLaComunidad> comunidad = new List<MiembroDeLaComunidad>();
